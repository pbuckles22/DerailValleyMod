...
1. **Hitch re-intro Step A** — Mods **0.4.56** (0.4.20 + Limit trend only). Smoke cadence. PASS → Step B (centered IA). FAIL → trend/ahead-scan is culprit. Introduce commit `7601aee`. Park do not merge.
