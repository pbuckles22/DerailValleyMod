...
public class TonnageDisplayTests
{
    ...
    {
        Assert.Equal("— t", TonnageDisplay.FormatFromKilograms(null));
        Assert.Equal("77 t", TonnageDisplay.FormatFromKilograms(77450f));
        Assert.Equal("30 t", TonnageDisplay.FormatFromKilograms(30400f));
    }
}
