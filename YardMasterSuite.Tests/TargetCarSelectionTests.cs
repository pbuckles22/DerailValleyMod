...
{
    [Fact]
    public void Resolve_prefers_standing_over_look_at()
    {
        Assert.Equal(TargetCarSource.Standing, TargetCarSelection.Resolve(hasStandingCar: true, hasLookAtCar: true));
    }
    ...
    [Fact]
    public void Resolve_standing_alone()
    {
